    ...
    return (
        <div className="min-h-screen   p-4 sm:p-6 lg:p-8">
            <div className="max-w-7xl mx-auto">
                {/* Header Section */}
                <div className=" bg-red-200 p-3 w-full sm:mb-12 rounded-2xl">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            
                            <div className='ml-8'>
                                <h1 className="text-3xl mb-3 sm:text-[50px] font-bold text-gray-900 dark:text-white">
                                    Donation History
                                </h1>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <div className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-lg border border-gray-200 dark:border-gray-700">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm text-gray-600 dark:text-gray-400">Lives Impacted</span>
                                    </div>
                                    <div className="text-2xl font-bold text-gray-900 dark:text-white mt-1">
                                        {donations.length * 3}
                                    </div>
                ...
                {donations.length === 0 ? (
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Achievement Section */}
                        <div className="mt-8 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl p-4 sm:p-8 text-white text-center">
