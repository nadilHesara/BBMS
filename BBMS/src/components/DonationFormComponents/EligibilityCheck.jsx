...
export default function EligibilityCheck() {
  ...
  useEffect(() => {
    ...
    if (form.age && form.age < 18) {
      toast.error("You are too yong to donate blood");
    } else if (form.age > 60) {
      toast.success("Thank you great citizen. You are now beyond the eligible limit for blood donation");
    }
  }, [form.age]);
  ...
  useEffect(() => {
    ...
    if (form.lastDonation && form.lastDonation !== "No Previous Donations" && form.lastDonation < 4 || form.lastDonation === 0) {
      toast.error("You are temporarily ineligible due to recent donations. Thank you for your support!");
    }
  }, [form.lastDonation]);

  useEffect(() => {
    if (form.risk && form.risk === "yes") {
      toast.error("You’re temporarily ineligible to donate due to risky behavior");
    }
  }, [form.risk]);
    ...
    <div className=" max-w-md mx-auto mt-5">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6 sm:p-8">
            ...
            <input
              ...
              onBlur={() => {
                if (form.weight && form.weight < 50) {
                  toast.error("Sorry, You must meet the minimum weight of 50kg to donate safely");
                }
              }}
            ...
            <input
              ...
              onBlur={() => {
                if (form.foreignTravel && form.foreignTravel < 3) {
                  toast.error("Sorry, Foreign travels within the last 3 months makes you temporarily ineligible to donate");
                }
              }}
        ...
        <div className="mt-4 text-center">
          <span className={`text-sm font-medium ${isEligible()
